...
const Dashboard: React.FC = () => {
  ...
  const stats: StatItem[] = [
    ...
    },
    {
      ...
      color: "bg-lavender-500", // Lavender
      path: "/roles",
    },
    {
    ...
    <div className="p-4 md:p-6 lg:p-8 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold mb-8 text-gray-800 flex items-center">
          <span className="bg-pink-500 w-2 h-8 mr-3 rounded-full"></span>
          Dashboard Overview
        </h2>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="border-b border-gray-100 p-6">
            <h3 className="text-lg font-semibold text-gray-800 flex items-center">
              <FiUserCheck className="w-5 h-5 mr-2 text-pink-500" />
              Users per Role
            </h3>
          </div>
          <div className="p-6">
              ...
              {usersPerRole.map((role, index) => (
                ...
                >
                  ...
                  <div className="flex items-center">
                    <span className="bg-pink-100 text-pink-800 py-1 px-3 rounded-full text-sm font-medium">
